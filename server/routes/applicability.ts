    ...
    try {
      ...
      const result = await query(
        `INSERT INTO question_applicability (cycle_id, question_id, bu_code, bu_name, assigned_by)
         VALUES ($1, $2, $3, $4, $5)
         ON CONFLICT (cycle_id, question_id, bu_code, COALESCE(material_risk, ''))
           DO UPDATE SET bu_name = EXCLUDED.bu_name, assigned_by = EXCLUDED.assigned_by, assigned_at = NOW()
         RETURNING *`,
