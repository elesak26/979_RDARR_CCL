...
BEGIN
  ...
  INSERT INTO dbo.users (id, display_name, role, unit_codes, primary_unit_code, is_active) VALUES (N'bu-012', N'EUC Regulation and Inventory', N'Responder', N'["012"]', N'012', 1);
  ...
  INSERT INTO dbo.users (id, display_name, role, unit_codes, primary_unit_code, is_active) VALUES (N'bu-905', N'IT', N'Responder', N'["905"]', N'905', 1);
  ...
  INSERT INTO dbo.users (id, display_name, role, unit_codes, primary_unit_code, is_active) VALUES (N'bu-943', N'Finance Function (943)', N'Responder', N'["943"]', N'943', 1);
  ...
  INSERT INTO dbo.users (id, display_name, role, unit_codes, primary_unit_code, is_active) VALUES (N'bu-committee-secretaries', N'Committee Secretaries', N'Responder', N'["Committee Secretaries"]', N'Committee Secretaries', 1);
  INSERT INTO dbo.users (id, display_name, role, unit_codes, primary_unit_code, is_active) VALUES (N'bu-dg-mle', N'Data Governance Cyprus', N'Responder', N'["DG MLE"]', N'DG MLE', 1);
